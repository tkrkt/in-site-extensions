...
export const historyLoaded = actionCreator<{ histories: Histories }>(
  "HISTORY_LOADED"
);

export const openHistory = actionCreator<{
  history: History;
  openInNew: boolean;
}>("OPEN_HISTORY");
export const removeHistory = actionCreator<{ history: History }>(
  "REMOVE_HISTORY"
);
export const removeAllHistories = actionCreator<{ host: string }>(
